...
<body>
    ...
    <div class="flex flex-col">
        ...
        <div class="inline-block min-w-full overflow-hidden align-middle border-b border-blue-950 shadow sm:rounded-lg">
            ...
            <thead>
                <tr>
                    <th class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">Instagram</th>
                    <th class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">LinkedIn</th>
                    <th class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">X</th>
                    <th class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">Facebook</th>
            ...
            <tbody class="bg-white">
                ...
                <tr>
                    ...
                    <td class="text-sm font-medium leading-5 whitespace-no-wrap border-b border-gray-200 ">
                        <a onclick="return confirm('Are You Sure You Want To Delete??');" href="delete_post.php?codigo=<?php echo $result->id_sosmed ?>"><svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-red-600 hover:text-red-800"
