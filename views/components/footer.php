...
<footer class="w-5/6 bg-sky-700 mt-16 ms-32 pt-10 pb-4 rounded-t-3xl shadow-lg border-blue-950 border-t-8">
        <div class="container">
            <div class="flex flex-wrap">
                ...
                <div class="w-full pr-10 mb-12"> 
                    <div class="w-full mb-4">
                        <label for="pesan" class="font-bold text-2xl text-white">Have any issues?</label>
                    ...
                    <div class="w-full">
                        <button type="submit" class="bg-blue-950 text-base font-semibold text-white py-3 px-8 rounded-full w-full hover:opacity-80 hover:shadow-lg transition duration-500">Submit</button>
                    </div>
                </div>
            </form>           
            </div>
